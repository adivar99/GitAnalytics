...
Revision ID: 9d109452566f
Revises: 
Create Date: 2024-06-28 13:17:43.629469
...
def upgrade() -> None:
    ...
    sa.Column('access', sa.Enum('MANAGER', 'READ_WRITE', 'GUEST', name='projectaccess', native_enum=False), nullable=True),
